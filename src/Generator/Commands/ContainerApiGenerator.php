...
namespace AdminKit\Porto\Generator\Commands;

use AdminKit\Porto\Generator\GeneratorCommand;
use AdminKit\Porto\Generator\Interfaces\ComponentsGenerator;
...
class ContainerApiGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $description = 'Create a Porto Container from scratch (API Part)';
    ...
    public function getUserInputs(): ?array
    {
        ...
        $this->call('porto:generate:provider', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('porto:generate:factory', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        foreach ($routes as $route) {
            ...
            if ($generateEvents) {
                $this->call('porto:generate:event', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['event'],
                    '--model' => $model,
            ...
            if ($generateTests) {
                $this->call('porto:generate:test:unit', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['unittest'],
                    '--model' => $model,
                ...
                $this->call('porto:generate:test:functional', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
